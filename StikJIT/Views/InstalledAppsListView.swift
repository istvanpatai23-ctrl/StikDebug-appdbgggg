...
struct AppButton: View {
    ...
    private func loadCachedIcon(bundleID: String) -> UIImage? {
        guard let containerURL = FileManager.default
            .containerURL(forSecurityApplicationGroupIdentifier: "group.to.appdb.jit-ios") else {
            return nil
        }
...
fileprivate func saveIconToGroup(_ image: UIImage, bundleID: String) {
    guard let data = image.pngData(),
          let container = FileManager.default
            .containerURL(forSecurityApplicationGroupIdentifier: "group.to.appdb.jit-ios")
    else { return }
